...
func (mr *MockProviderMockRecorder) NewSession(ctx interface{}, opts ...interface{}) *gomock.Call {
...
func (m *MockProvider) Transaction(ctx context.Context, fn func(*gorm.DB) error, opts ...db.Option) error {
	m.ctrl.T.Helper()
...
func (mr *MockProviderMockRecorder) Transaction(ctx, fn interface{}, opts ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
